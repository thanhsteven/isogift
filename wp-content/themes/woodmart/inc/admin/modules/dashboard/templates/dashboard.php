		...
		<div class="xts-row xts-welcome-row xts-sp-20 xts-theme-style">
			<div class="xts-col-12 xts-col-xl-6">
				<div class="xts-box xts-info-boxes">
					<div class="xts-box-content">
						<h4>
							<?php esc_html_e( 'Need Help?', 'woodmart' ); ?>
						</h4>

						<p>
							<?php esc_html_e( 'Use these links for more information!', 'woodmart' ); ?>
						</p>
			...
			<div class="xts-col-12 xts-col-xl-6">
				<div class="xts-box xts-info-boxes xts-align-center">
					<div class="xts-box-content">
						<h4>
							<?php esc_html_e( 'Do you like theme?', 'woodmart' ); ?>
						</h4>

						<p>
							<?php esc_html_e( 'Leave a comment on Themeforest!', 'woodmart' ); ?>
						</p>
