...
class Instagram_Api extends Field {
	...
	public function render_control() {
		...
		?>
			<div class="xts-upload-btns">
				<a href="<?php echo esc_url( $this->get_link() ); ?>" class="xts-btn xts-color-primary">
					<?php esc_html_e( 'Connect', 'woodmart' ); ?>
				</a>

				<?php if ( $instagram_access_token ) : ?>
					<a href="<?php echo $this->get_return_url() . '&instagram_account_disconnect'; ?>" class="xts-btn xts-color-warning xts-remove-upload-btn xts-i-trash">
	...
	public function get_return_url() {
		return admin_url( 'admin.php' ) . '?page=xts_theme_settings&tab=api_integrations_section';
	}
